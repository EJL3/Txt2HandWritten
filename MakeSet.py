...
text = font.render("Text To Hand Written", True, (62, 97, 219))
...
txt2 = txtfont.render("Clear", True, (255,0,0))
txt3 = txtfont.render("Create New Set", True, (0,128,0))
font = pygame.font.Font("freesansbold.ttf", 25)
text = font.render("BY Rizwan AR", True, (62, 97, 219))
